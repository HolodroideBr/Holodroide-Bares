   ...
   <div class="container" style="margin-bottom:200px;">
      ...
      <div class="row">
          <div class="col-md-12" style="text-align:LEFT;margin:50px 0 10px 0;"><img src="../images/logo_holodroide_sistema.png" width="300" height="32" alt=""/><br />
              <h4>ADMIN - CADASTRAR NOVO ADMINISTRADOR</h4><br>
    ...
    <span class="caret"></span>
      ...
      <div class="row">
           <div class="col-md-12" style="text-align:left;margin:0 0 30px 0;">
            <h5>Preencha o formulário com os dados do novo administrador e clique no botão "CADASTRAR"</h5>
          </div>
      </div>  

      <!-- Formulário CADASTRAR NOVO ADMINISTRADOR -->
      <form action="adm-add.php" method="post" name="adm-add-form" id="adm-add-form">
      <div class="row">
          <div class="col-md-1" style="text-align:right;padding:5px;">        
            Nome:
          </div>
          <div class="col-md-11" style="text-align:left;padding:5px;">        
            <input name="nome_adm" type="text" id="nome_adm" size="65" value="">
          </div>          
      </div>  
      ...
      <div class="row">
          ...
          <div class="col-md-11" style="text-align:left;padding:5px;">        
            <input name="email_adm" type="text" id="email_adm" size="65" value="">
          </div>          
      </div>  
      ...
      <div class="row">
          ...
          <div class="col-md-11" style="text-align:left;padding:5px;">        
            <input name="senha_adm" type="text" id="senha_adm" size="65" value="">
          </div>          
      </div>              
