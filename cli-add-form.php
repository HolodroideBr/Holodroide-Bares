   ...
   <div class="container" style="margin-bottom:200px;">
      ...
      <div class="row">
          <div class="col-md-12" style="text-align:LEFT;margin:50px 0 10px 0;"><img src="../images/logo_holodroide_sistema.png" width="300" height="32" alt=""/><br />
              <h4>ADMIN - CADASTRAR NOVO CLIENTES</h4><br>
    ...
    <span class="caret"></span>
      ...
      <div class="row">
          <div class="col-md-12" style="text-align:left;margin:0 0 30px 0;">
            <h5>Preencha o formulário com os dados do novo cliente e clique no botão "CADASTRAR"</h5>
          </div>
       </div> 
      ...
      <div class="row">
          ...
          <div class="col-md-10" style="text-align:left;padding:5px;">        
            <input name="empresa_cli" type="text" id="empresa_cli" size="65" value="">
          </div>          
      </div>  
      ...
      <div class="row">
          ...
          <div class="col-md-10" style="text-align:left;padding:5px;">        
            <input name="nome_cli" type="text" id="nome_cli" size="65" value="">
          </div>          
      </div>  
      ...
      <div class="row">
          ...
          <div class="col-md-10" style="text-align:left;padding:5px;">        
            <input name="email_cli" type="text" id="email_cli" size="65" value="">
          </div>          
      </div>  
      ...
      <div class="row">
          ...
          <div class="col-md-10" style="text-align:left;padding:5px;">        
            <input name="senha_cli" type="text" id="senha_cli" size="65" value="">
          </div>          
      </div>  
