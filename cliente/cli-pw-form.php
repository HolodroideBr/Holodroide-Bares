...
// pega o ID da do cliente na variável de sessão
...
$sql = "SELECT empresa_cli, nome_cli, email_cli, senha_cli, imglogo_cli, usr_cli FROM tbl_cli WHERE id_cli = :idcli";
     ...
     <div class="container" style="margin-bottom:200px;">
        ...
        <div class="row">
          <div class="col-md-12" style="text-align:left;margin:50px 0 10px 0;"><img src="../../images/logo_holodroide_sistema.png" width="300" height="32" alt=""/><br />
              <h4>CLIENTE - ALTERAR SENHA</h4><br>
    ...
    <span class="caret"></span>
      ...
      <div class="row">
          <div class="col-md-12" style="text-align:left;margin:0 0 30px 0;">
           <h5>Digite a nova senha para o cliente e clique no botão "ALTERAR SENHA"</h5>
          </div>
      </div> 
      ...
      <div class="row">
          ...
          <div class="col-md-10" style="text-align:left;padding:5px;">        
            <input name="senha_cli" type="text" id="senha_cli" size="50" value="">
          </div>          
      </div>  
