...
if (empty($idusr))
{
  echo '<script type="text/javascript">
        alert("OH, BOY... NÃO RECEBEMOS O ID!");
        window.history.back()
      </script>';
  exit;
}
     ...
     <div class="container" style="margin-bottom:200px;">
        ...
        <div class="row">
          <div class="col-md-12" style="text-align:left;margin:50px 0 10px 0;"><img src="../../images/logo_holodroide_sistema.png" width="300" height="32" alt=""/><br />
              <h4>CLIENTE - ALTERAR CADASTRO USUÁRIO</h4><br>
    ...
    <span class="caret"></span>
      ...
      <div class="row">
          <div class="col-md-12" style="text-align:left;margin:0 0 30px 0;">
            <h5>Altere os dados desejados em clique no botão "ALTERAR"</h5>
          </div>
      </div> 
      ...
      <div class="row">
          ...
          <div class="col-md-10" style="text-align:left;padding:5px;">        
            <input name="nome_usr" type="text" id="nome_usr" size="50" value="<?php echo $user['nome_usr'] ?>">
          </div>          
      </div>  
      ...
      <div class="row">
          ...
          <div class="col-md-10" style="text-align:left;padding:5px;">        
            <input name="email_usr" type="text" id="email_usr" size="50" value="<?php echo $user['email_usr'] ?>">
          </div>          
      </div>  
      ...
      <div class="row">
          ...
          <div class="col-md-10" style="text-align:left;padding:5px;">        
              ...
              <?php echo $_SESSION['cli_name']; ?>
              <p style="font-size:0.800em;"><br>
              Obs: O cliente associado ao usuário não pode ser alterado.</p>
          </div>          
      </div>        
