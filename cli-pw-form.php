...
$sql = "SELECT nome_cli, email_cli, senha_cli FROM tbl_cli WHERE id_cli = :idcli";
     ...
     <div class="container" style="margin-bottom:200px;">
      ...
      <div class="row">
          <div class="col-md-12" style="text-align:LEFT;margin:50px 0 30px 0;">
              ...
              <h4>ADMIN - ALTERAR SENHA CLIENTE</h4>
          </div>
      </div>
    ...
    <span class="caret"></span>
      ...
      <div class="row">
          <div class="col-md-12" style="text-align:left;margin:0 0 30px 0;">
            <h4><p class="MsoNormal">Digite a nova senha para o cliente e clique no botão "ALTERAR SENHA"</p></h4>
      ...
      <div class="row">
          <div class="col-md-2" style="text-align:left;padding:5px;">        
            Nome:
          </div>
